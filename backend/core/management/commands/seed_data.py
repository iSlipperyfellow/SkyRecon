...
from core.models import Drone, Flight, Runway, Detection, Hazard
    ...
    def _create_drones(self):
        ...
        for drone_data in drones_data:
            drone, created = Drone.objects.get_or_create(
                identifier=drone_data['identifier'],
                defaults=drone_data
            )
        ...
        for det_data in detections_data:
            try:
                ...
                if created:
                    ...
                    self.stdout.write(f"  • Detection already exists: {detection.label}")
