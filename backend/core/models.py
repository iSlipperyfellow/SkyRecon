...
class Flight(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=FLIGHT_STATUS_CHOICES, default="PLANNED"
    )
...
class Detection(models.Model):
    ...
    drone = models.ForeignKey(
        Drone, on_delete=models.CASCADE, related_name="detections"
    )
    flight = models.ForeignKey(Flight, on_delete=models.SET_NULL, null=True, blank=True)
    timestamp = models.DateTimeField(db_index=True)
...
class Hazard(models.Model):
    ...
    detection = models.OneToOneField(
        Detection, on_delete=models.CASCADE, related_name="hazard"
    )
...
class InferenceJob(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    drone = models.ForeignKey(
        Drone, on_delete=models.CASCADE, related_name="inference_jobs"
    )
    flight = models.ForeignKey(Flight, on_delete=models.SET_NULL, null=True, blank=True)
...
class NavigationPlan(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    drone = models.ForeignKey(
        Drone, on_delete=models.CASCADE, related_name="navigation_plans"
    )
    flight = models.ForeignKey(Flight, on_delete=models.SET_NULL, null=True, blank=True)
...
class AIModel(models.Model):
    ...
    framework = models.CharField(
        max_length=20, choices=FRAMEWORK_CHOICES, default="YOLO"
    )
